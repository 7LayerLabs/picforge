...
import { Image as ImageIcon, Images, Layers, Sparkles, Menu, X, Lightbulb, Trophy, Flame, Shuffle, Wand2, ChevronDown, Gamepad2, Star, Crown, User } from 'lucide-react';
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex">
            ...
            <div className="hidden sm:ml-4 sm:flex sm:space-x-2">
              ...
              >
                <User className="w-3 h-3 mr-1.5 text-teal-500" />
                Profile
              </Link>
            </div>
          </div>
