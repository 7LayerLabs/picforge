    ...
    <div className={`${className}`}>
      ...
      {showHeader && (
        <div className="text-center mb-4">
          <h2 className="font-heading text-2xl md:text-3xl font-black text-black mb-4 uppercase">
            See What&apos;s Possible
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-4">
            <button
              ...
              className={`px-3 py-1.5 font-black uppercase text-xs border-4 border-black transition-all ${
            ...
            <button
              ...
              className={`px-3 py-1.5 font-black uppercase text-xs border-4 border-black transition-all ${
                activeFilter === 'featured'
                  ...
                  : 'bg-white text-black hover:bg-brutal-pink hover:text-white'
              }`}
            >
              Featured
            </button>
            <button
              ...
              className={`px-3 py-1.5 font-black uppercase text-xs border-4 border-black transition-all ${
                activeFilter === 'recent'
                  ...
                  : 'bg-white text-black hover:bg-brutal-cyan'
              }`}
            >
              Recent
            </button>
      ...
      <div className="mt-8 text-center">
        <Link
          href="/showcase"
          className="inline-flex items-center gap-3 px-8 py-4 bg-brutal-pink text-white font-black text-lg uppercase border-4 border-black shadow-brutal hover:shadow-brutal-hover hover:translate-x-1 hover:translate-y-1 transition-all"
        >
          View More
