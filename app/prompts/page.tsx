            ...
            <div className="mb-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                />
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                {promptLibrary.map(cat => (
                  ...
                  >
                    ...
                    <span className="text-left flex-1">{cat.category}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            {searchTerm && (
              <div className="mt-6 pt-4 border-t border-gray-200">
                <p className="text-sm text-gray-600">
                  Found <span className="font-semibold text-blue-600">{filteredPrompts.reduce((acc, cat) => acc + cat.prompts.length, 0)}</span> prompts matching &quot;{searchTerm}&quot;
                </p>
              </div>
            )}
          </div>
