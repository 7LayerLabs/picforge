...
// Showcase moderation feature - currently disabled
// This feature uses an old InstantDB API that needs updating
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900">
      <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-md text-center">
        ...
        <p className="text-gray-600">
          This feature is currently being updated and is temporarily unavailable.
        </p>
      </div>
    </div>
  )
...
/*
OLD CODE - Needs InstantDB API update
...
function OldModerationQueuePage() {
        ...
        {filtered.map(s => (
          <div key={s.id} className="border rounded-lg overflow-hidden bg-white">
            <div className="grid grid-cols-2 gap-0">
              <Image src={s.originalImageUrl} alt="original" width={300} height={160} className="w-full h-40 object-cover" />
              <Image src={s.transformedImageUrl} alt="transformed" width={300} height={160} className="w-full h-40 object-cover" />
            </div>
