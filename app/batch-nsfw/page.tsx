...
// Import the actual batch processor component
import BatchProcessor from '@/app/components/BatchProcessorNSFW'

export default function BatchNSFWPage() {
  ...
  // User is verified, show the batch processor
