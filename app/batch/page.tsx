    ...
    <div className="min-h-screen bg-gray-50 relative">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-sm text-gray-600">
                {stats.total === 0 ? (
                  <span className="font-medium">No images loaded</span>
                ) : (
                  <>
                    <span className="font-medium">{processedCount} of {stats.total} images processed</span>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Available Effects - UPDATED with tooltips! */}
          <div className="bg-purple-50 rounded-xl p-6 mb-6">
            <h3 className="font-semibold text-purple-900 mb-3 text-lg">✨ 21 Available Effects - Hover for Details!</h3>
            <p className="text-sm text-purple-700 mb-4">Hover over any effect to see what it does, then type it below (or combine multiple!)</p>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-3">
              <EffectTooltip effect="grayscale" icon="🎨" description="Converts image to black and white" example="grayscale contrast" />
              <EffectTooltip effect="invert" icon="🔄" description="Reverses all colors (negative effect)" example="invert blur" />
              <EffectTooltip effect="sepia" icon="📜" description="Vintage brown-toned filter" example="sepia grain vignette" />
              <EffectTooltip effect="blur" icon="💫" description="Softens image with gaussian blur" example="blur bright" />
              <EffectTooltip effect="bright" icon="☀️" description="Increases brightness by 50%" example="bright contrast" />
              <EffectTooltip effect="dark" icon="🌙" description="Reduces brightness by 50%" example="dark vignette" />
              <EffectTooltip effect="contrast" icon="⚡" description="Boosts difference between lights/darks" example="grayscale contrast" />
              <EffectTooltip effect="red" icon="🟥" description="Boosts red channel, reduces others" example="red dark" />
              <EffectTooltip effect="blue" icon="🟦" description="Boosts blue channel, reduces others" example="blue dark" />
              <EffectTooltip effect="green" icon="🟩" description="Boosts green channel, reduces others" example="green bright" />
              <EffectTooltip effect="pixelate" icon="🎮" description="8-bit retro pixel effect" example="pixelate" />
              <EffectTooltip effect="sharpen" icon="✨" description="Enhances edges and details" example="sharpen enhance" />
              <EffectTooltip effect="vignette" icon="📷" description="Darkens corners for focus" example="warm vignette" />
              <EffectTooltip effect="saturation" icon="🎨" description="Boosts color intensity" example="saturation sharpen" />
              <EffectTooltip effect="warm" icon="🔥" description="Adds warm orange/yellow tones" example="warm vignette" />
              <EffectTooltip effect="cool" icon="❄️" description="Adds cool blue tones" example="cool grain" />
              <EffectTooltip effect="grain" icon="🎞️" description="Adds film grain texture" example="sepia grain" />
              <EffectTooltip effect="glitch" icon="📺" description="VHS distortion effect" example="glitch grain" />
              <EffectTooltip effect="sketch" icon="✏️" description="Pencil drawing effect" example="sketch sharpen" />
              <EffectTooltip effect="resize" icon="📐" description="Optimizes to max 1920px width" example="resize enhance" />
              <EffectTooltip effect="enhance" icon="⚙️" description="Auto-adjusts levels and contrast" example="enhance sharpen" />
            </div>
            <div className="mt-4 p-3 bg-white rounded-lg border border-purple-200">
              ...
              <ul className="text-xs text-purple-600 space-y-1 pl-4">
                <li>• Combine 2-3 effects for best results: &quot;warm vignette grain&quot;</li>
                <li>• Order matters: &quot;grayscale contrast&quot; ≠ &quot;contrast grayscale&quot;</li>
                <li>• Start simple, then experiment with combinations!</li>
              </ul>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                {!isProcessing ? (
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-xl transition-all flex items-center gap-2"
                  >
                ...
                {stats.completed > 0 && (
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-xl font-medium transition-all flex items-center gap-2"
                    >
                      <Sparkles className="w-4 h-4" />
                      Export for Cricut/Etsy ({stats.completed})
                    </button>
                  </div>
                )}
              </div>
