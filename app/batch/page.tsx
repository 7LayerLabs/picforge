      ...
      <div className="container mx-auto px-4 py-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-4">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-purple-100 text-purple-700 rounded-full mb-2 shadow-sm">
              <Layers className="w-3.5 h-3.5" />
              <span className="text-xs font-bold tracking-wide">BATCH PROCESSING</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl font-black text-gray-900 mb-1.5 leading-tight tracking-tight shadow-sm">
              <span className="bg-teal-600 bg-clip-text text-transparent">
                Obliterate 100+ Images at Once
              </span>
            </h1>
            <p className="text-base text-gray-700 max-w-2xl mx-auto font-bold leading-snug">
              One effect. Infinite images. Zero patience required.
            </p>
          </div>
                  ...
                  {!isProcessing ? (
                    <>
                      <button
                        ...
                        className="flex-1 px-8 py-4 bg-teal-600 text-white text-base font-black uppercase rounded-lg hover:bg-teal-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg hover:shadow-xl tracking-tight"
                      >
