                  ...
                  {!isProcessing ? (
                    <>
                      <button
                        ...
                        className="flex-1 px-6 py-3 bg-teal-600 text-white text-base font-black rounded-lg hover:bg-teal-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-md tracking-tight"
                      >
