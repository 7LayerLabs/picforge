        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-lg text-black max-w-2xl mx-auto font-bold leading-snug">
              <span className="text-brutal-cyan">100+ images.</span> <span className="text-brutal-pink">One click.</span> <span className="bg-brutal-yellow px-2">Zero patience.</span>
            </p>
          </div>
