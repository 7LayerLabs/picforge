    ...
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Progress Bar - Only show when images are loaded */}
          {stats.total > 0 && (
            <BatchProgressBar
              total={stats.total}
          ...
          {/* Effect Library - Organized by Category */}
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-sm font-medium text-gray-700">
                    Your Effect Combination {prompt && <span className="text-teal-600 font-bold">({prompt.split(' ').length} effects)</span>}
                  </label>
                ...
                <textarea
                  ...
                  placeholder="Click effects above to add them here, or type manually: sharpen vignette saturation, warm cool grain, etc."
                  className="w-full p-3 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:outline-none resize-none h-24 font-mono"
                  disabled={isProcessing}
                />
                <p className="text-xs text-gray-500 mt-1">
                  💡 Click effects in the library above to build your combination, or type manually
                </p>
              </div>
