          ...
          <div className="bg-black rounded-2xl p-8">
            ...
            {hasUnlimitedAccess ? (
              ...
              <form onSubmit={handleRedeem} className="space-y-4">
                ...
                {error && (
                  <div className="p-4 bg-red-900 bg-opacity-20 border border-red-500 rounded-xl flex items-start gap-3">
                ...
                {success && (
                  <div className="p-4 bg-gray-900 border-2 border-teal-500 rounded-xl flex items-start gap-3 animate-bounce">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-teal-500 text-black rounded-xl font-bold hover:bg-teal-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isRedeeming ? (
                    <>
