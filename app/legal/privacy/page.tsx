      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-black border-4 border-brutal-cyan shadow-brutal-lg p-8 mb-8">
          <div className="flex items-center gap-3 mb-4">
            <Shield className="w-10 h-10 text-brutal-cyan" />
        ...
        <div className="bg-black border-4 border-brutal-cyan shadow-brutal p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <a href="#data-collection" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ Data We Collect</a>
            <a href="#how-we-use" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ How We Use Data</a>
            <a href="#third-party" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ Third-Party Services</a>
            <a href="#your-rights" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ Your Privacy Rights</a>
            <a href="#cookies" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ Cookies & Tracking</a>
            <a href="#security" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ Data Security</a>
            <a href="#retention" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ Data Retention</a>
            <a href="#contact" className="text-brutal-cyan hover:text-brutal-pink text-sm font-bold">→ Contact Us</a>
          </div>
        </div>
        ...
        <div className="bg-white border-4 border-black shadow-brutal-lg p-8 space-y-8">
          ...
          <section id="data-collection">
            <div className="flex items-center gap-2 mb-4">
              <Database className="w-6 h-6 text-brutal-cyan" />
          ...
          <section id="how-we-use">
            <div className="flex items-center gap-2 mb-4">
              <Eye className="w-6 h-6 text-brutal-cyan" />
              <h2 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Courier New, monospace' }}>
          ...
          <section id="third-party">
            <div className="flex items-center gap-2 mb-4">
              <Globe className="w-6 h-6 text-brutal-cyan" />
              <h2 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Courier New, monospace' }}>
                Third-Party Services
              </h2>
            </div>
          ...
          <section id="your-rights">
            <div className="flex items-center gap-2 mb-4">
              <Shield className="w-6 h-6 text-brutal-cyan" />
              <h2 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Courier New, monospace' }}>
                Your Privacy Rights
              </h2>
            </div>
          ...
          <section id="cookies">
            <div className="flex items-center gap-2 mb-4">
              <Cookie className="w-6 h-6 text-brutal-cyan" />
              <h2 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Courier New, monospace' }}>
          ...
          <section id="security">
            <div className="flex items-center gap-2 mb-4">
              <Lock className="w-6 h-6 text-brutal-cyan" />
              <h2 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Courier New, monospace' }}>
                Data Security
              </h2>
            </div>
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              <FileText className="w-6 h-6 text-brutal-cyan" />
              <h2 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Courier New, monospace' }}>
          ...
          <section id="contact">
            <div className="flex items-center gap-2 mb-4">
              <Mail className="w-6 h-6 text-brutal-cyan" />
              <h2 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Courier New, monospace' }}>
                Contact Us
              </h2>
            </div>
        ...
        <div className="mt-8 text-center space-y-2">
          <div className="flex justify-center gap-4 text-sm">
            <Link href="/legal/terms" className="text-brutal-cyan hover:text-brutal-pink hover:underline font-bold">
              Terms of Service
            </Link>
