      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <a href="#acceptance" className="text-teal-700 hover:text-teal-900 text-sm">→ Acceptance of Terms</a>
            <a href="#eligibility" className="text-teal-700 hover:text-teal-900 text-sm">→ Eligibility</a>
            <a href="#account" className="text-teal-700 hover:text-teal-900 text-sm">→ Account Management</a>
            <a href="#services" className="text-teal-700 hover:text-teal-900 text-sm">→ Service Description</a>
            <a href="#acceptable-use" className="text-teal-700 hover:text-teal-900 text-sm">→ Acceptable Use Policy</a>
            <a href="#content" className="text-teal-700 hover:text-teal-900 text-sm">→ User Content & Ownership</a>
            <a href="#pricing" className="text-teal-700 hover:text-teal-900 text-sm">→ Pricing & Payments</a>
            <a href="#intellectual-property" className="text-teal-700 hover:text-teal-900 text-sm">→ Intellectual Property</a>
            <a href="#termination" className="text-teal-700 hover:text-teal-900 text-sm">→ Termination</a>
            <a href="#liability" className="text-teal-700 hover:text-teal-900 text-sm">→ Liability & Disclaimers</a>
            <a href="#disputes" className="text-teal-700 hover:text-teal-900 text-sm">→ Dispute Resolution</a>
            <a href="#contact" className="text-teal-700 hover:text-teal-900 text-sm">→ Contact Information</a>
          </div>
        </div>
        ...
        <div className="mt-8 text-center space-y-2">
          <div className="flex justify-center gap-4 text-sm">
            <Link href="/legal/privacy" className="text-teal-600 hover:text-teal-800 hover:underline">
              Privacy Policy
            </Link>
